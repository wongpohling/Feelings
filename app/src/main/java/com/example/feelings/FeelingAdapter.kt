...
class FeelingAdapter internal constructor(context: Context): RecyclerView.Adapter<FeelingAdapter.FeelingViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeelingAdapter.FeelingViewHolder {
    ...
    override fun onBindViewHolder(holder: FeelingAdapter.FeelingViewHolder, position: Int) {
    ...
    fun setFeelingList(feelingList: List<Feeling>){
        this.feelingList = this.feelingList
